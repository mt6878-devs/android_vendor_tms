...
#ifdef TMS_NFC
  if ((line.find("TMS_RF_CONF_BLK") != string::npos) ||
      (line.find("TMS_CORE_CONF") != string::npos) ||
      (line.find("TMS_CORE_CONF_EXTN") != string::npos)) {
...
#ifdef TMS_NFC
    if (cur_file_name_.find("tmsTransit") != std::string::npos) {
