...
#define NFA_TMS_RF_LISTEN_MASK_A 0x1
#define NFA_TMS_RF_LISTEN_MASK_B 0x2
#define NFA_TMS_RF_LISTEN_MASK_F 0x4
#define NFA_TMS_RF_LISTEN_NOT_SPECIFIED 0xF0
#endif
...
#ifdef TMS_NFC
  tNFA_CI_PARAMS ci;   /* China ID Card */
#endif
} tNFA_TAG_PARAMS;
...
**                  NFA_STATUS_FAILED otherwise
*******************************************************************************/
extern tNFA_STATUS NFA_SetTmsRfListenMask(uint8_t listenMask);
...
*******************************************************************************/
extern uint8_t NFA_GetTmsRfListenMask();

extern tNFA_STATUS NFA_WaitVsResponse(tNFA_VSC_CBACK* p_cback);
extern tNFA_STATUS NFA_SetPassthroughMode(uint8_t mode, tNFA_VSC_CBACK* p_cback);
extern tNFA_STATUS NFA_SendRawPtmCommand(uint16_t cmd_params_len,uint8_t* p_cmd_params);
#endif
