...
#ifdef TMS_NFC
/* receive an ATR */
#define NFA_HCI_ABORT_APDU_EVT 0x17
#define NFA_HCI_R_APDU_EVT 0x18
#endif
...
#ifdef TMS_NFC
/* data type for NFA_HCI_ABORT_APDU_EVT */
typedef struct {
    tNFA_STATUS status; /* Status of abort apdu operation */
    uint16_t atr_len;
    uint8_t *p_atr;
    uint8_t host_id;
} tNFA_HCI_ABORT_APDU;

/* data type for NFA_HCI_R_APDU_EVT */
typedef struct {
    tNFA_STATUS status; /* Status of apdu transceive operation */
    uint16_t rsp_len;
    uint8_t *p_rsp;
    uint8_t host_id;
} tNFA_HCI_R_APDU;
...
#ifdef TMS_NFC
    tNFA_HCI_ABORT_APDU abort_apdu;        /* NFA_HCI_ABORT_APDU_EVT */
    tNFA_HCI_R_APDU rcv_apdu;              /* NFA_HCI_R_APDU_EVT */
#endif
} tNFA_HCI_EVT_DATA;
...
**
*******************************************************************************/
extern tNFA_STATUS NFA_HciAbortApdu(tNFA_HANDLE hci_handle, uint8_t host_id, uint32_t rsp_timeout);
...
**
*******************************************************************************/
extern tNFA_STATUS NFA_HciSendApdu(tNFA_HANDLE hci_handle, uint8_t host_id,
...
**
*******************************************************************************/
extern tNFA_STATUS NFA_HciEndApdu(tNFA_HANDLE hci_handle, uint8_t host_id);
#endif /* TMS_NFC */
#endif /* NFA_P2P_API_H */
