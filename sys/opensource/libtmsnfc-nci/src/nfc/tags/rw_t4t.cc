...
/*******************************************************************************
**
** Function         rw_t4t_send_apdu
**
** Description      send raw apdu to t4t nfcee
**
** Returns          TRUE if success
**
*******************************************************************************/
static bool rw_t4t_send_apdu(void) {
  tRW_T4T_CB* p_t4t = &rw_cb.tcb.t4t;
  NFC_HDR* p_c_apdu;
  uint8_t* p;
  uint32_t length;
...
/*******************************************************************************
**
** Function         RW_T4tNfceeSendRawApdu
**
** Description      Send Apdu to t4t nfc ee
**
** Returns          NFC_STATUS_OK if success
**
*******************************************************************************/
tNFC_STATUS RW_T4tNfceeSendRawApdu(uint16_t length, uint8_t* p_data) {
  DLOG_IF(INFO, nfc_debug_enabled) << StringPrintf("%s Enter ", __func__);
  rw_cb.tcb.t4t.p_update_data = p_data;
  rw_cb.tcb.t4t.rw_offset = T4T_FILE_LENGTH_SIZE;
  rw_cb.tcb.t4t.rw_length = length;
