...
/* Callback event. Make sure it's equal to what the nfc hal defines. */
enum {
...
#ifdef TMS_NFC
extern void NFC_MarkWaitVsResponse(void* p_cback);
extern void NFC_SetPassthroughMode(uint8_t mode, void* p_cback);
#endif
#endif /* NFC_INT_H_ */
