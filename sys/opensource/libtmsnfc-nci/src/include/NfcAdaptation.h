...
/* copy from vendor/tms/vnd/opensource/halimpl/nfc/THN31/extns/impl/tmsnfc/1.0/TmsNfc.h */
enum {
    FILE_TYPE_TMS = 0,
    FILE_TYPE_RF,
};
...
#ifdef TMS_NFC
  std::string HalGetProperty(std::string key);
  bool HalSetProperty(std::string key, std::string value);
  static bool HalCheckIfConfigIsModified();
  std::string propVal;
#endif
...
#ifdef TMS_NFC
  static android::sp<vendor::tms::tmsnfc::V1_0::ITmsNfc> mHalTmsNfc;
#endif
