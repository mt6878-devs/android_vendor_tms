...
public class CardEmulationManager implements RegisteredServicesCache.Callback,
    ...
    public void onServicesUpdated(int userId, List<ApduServiceInfo> services,
        ...
        // #ifdef TMS_NFC
        mPreferredServices.computeDefaultRouteFromDefaultPayment(); //compute default all route before aid cache update
        // #endif
    ...
    final class CardEmulationInterface extends INfcCardEmulation.Stub {
        ...
        public ApduServiceInfo getPreferredPaymentService(int userId) throws RemoteException {
            ...
            // #ifdef TMS_NFC
            try {
                // sleep 50ms waiting for Settings.Secure.putString(NFC_PAYMENT_DEFAULT_COMPONENT)
                Thread.sleep(50);
            } catch (Exception e) {
                if (DBG) {
...
//#ifdef TMS_NFC
    public void onRoutingTableChanged() {
        ...
        //mAidCache.onPreferredPaymentServiceChanged(null);
        //mHostEmulationManager.onPreferredPaymentServiceChanged(null);
    }
//#endif
