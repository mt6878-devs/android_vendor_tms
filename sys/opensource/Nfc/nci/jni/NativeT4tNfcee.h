...
typedef enum { OP_READ = 0, OP_WRITE, OP_CLEAR, OP_SEND_APDU } T4TNFCEE_OPERATIONS_t;
...
class NativeT4tNfcee {
  ...
  ** Returns:         none
  *******************************************************************************/
  void t4tSendApduComplete(tNFA_STATUS status, tNFA_RX_DATA data);
  /*******************************************************************************
  **
  ...
  **
  *******************************************************************************/
  bool enableT4tNfcee(JNIEnv* e, jobject o, jboolean enable);
  /*******************************************************************************
  **
  ...
  **
  *******************************************************************************/
  jbyteArray t4tSendRawApdu(JNIEnv* e, jobject o, jbyteArray apdu, jint apduLen);
  /*******************************************************************************
  **
 ...
 private:
  bool mBusy;
  static const int TMS_NFC_CLPARAM_ID_T4T_NFCEE = 0x95;
  static const int TMS_NFC_CPARAM_ID_T4T_NFCEE = 0x10;
  static const int TMS_NFC_NUM_PARAM_T4T_NFCEE = 0x02;
  static const int TMS_PARAM_LEN_T4T_NFCEE = 0x01;
  ...
  static const int TMS_PARAM_GET_CONFIG_INDEX = 4;
  static const int TMS_PARAM_GET_CONFIG_INDEX1 = 8;
  static const int TMS_PARAM_SET_CONFIG_LEN = 0x09;
  static const int TMS_PARAM_SET_CONFIG_PARAM = 0x02;
