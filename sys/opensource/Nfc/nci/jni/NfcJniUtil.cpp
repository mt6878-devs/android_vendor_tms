...
jint JNI_OnLoad(JavaVM* jvm, void*) {
  ...
  if (RoutingManager::getInstance().registerJniFunctions(e) == -1)
    return JNI_ERR;
#ifdef TMS_NFC
  if (tms::register_com_tms_nfc_TmsNativeNfcManager(e) == -1)
    return JNI_ERR;
  if (tms::register_com_tms_nfc_TmsNativeNfcConfig(e) == -1)
    return JNI_ERR;
  if (tms::register_com_tms_nfc_TmsNativeWiredSe(e) == -1)
    return JNI_ERR;
  if (tms::register_com_android_nfc_NativeT4tNfcee(e) == -1)
    return JNI_ERR;
#endif
