...
// #ifdef TMS_NFC
import com.tms.nfc.dhimpl.TmsNativeNfcTag;
...
public class NativeNfcTag implements TagEndpoint {
    ...
    //#ifdef TMS_NFC
    private final TmsNativeNfcTag mTmsNativeNfcTag = new TmsNativeNfcTag(this);
    //#endif
    ...
    public synchronized boolean formatNdef(byte[] key) {
        ...
        //#ifdef TMS_NFC
        boolean result;
        if (mTmsNativeNfcTag.hookFormatNdef()) {
            result = mTmsNativeNfcTag.formatNdef(key);
        } else {
